...
class UserTableSeeder extends Seeder
{
  public function run()
  {
    ...
    if (!$is_exist->count()) {
        ...
        $student->email = 'student@BLEND.com';
        ...
        $instructor_user->email = 'instructor@BLEND.com';
        ...
        $instructor->contact_email = 'instructor@BLEND.com';
        $instructor->telephone = '+61 (800) 123-54323';
        $instructor->mobile = '+61 800-1233-8766';
        $instructor->paypal_id = 'instructor@BLEND.com';
